...
def authenticated_menu():
    ...
    if st.session_state.role in ["admin", "super-admin"]:
        ...
        st.sidebar.page_link("pages/super_admin.py", label="Manage admin access",
...
def menu():
    ...
    st.logo("img/bb_png.png", size="large", link="http://localhost:8501", icon_image="img/bb_png.png")
